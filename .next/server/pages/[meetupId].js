...
const getStaticPaths = async () => {
  const client = await external_mongodb_["MongoClient"].connect(`mongodb+srv://${process.env.USERNAME}:${process.env.API_KEY}@cluster0.vmnfv.mongodb.net/meetups?retryWrites=true&w=majority`);
  const db = client.db();
